...
const Queue: React.FC<QueueProps> = ({ setView }) => {
  ...
  // handleChatSend function removed
  ...
  return (
    <div
      ...
      className="select-none max-w-full overflow-hidden"
    >
      <div className="bg-transparent w-full max-w-full overflow-hidden relative">
